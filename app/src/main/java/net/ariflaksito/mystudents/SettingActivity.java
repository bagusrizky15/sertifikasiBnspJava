...
import net.ariflaksito.mystudents.user.db.LoginActivity;
import net.ariflaksito.mystudents.user.db.RegisterActivity;
import net.ariflaksito.mystudents.user.db.dbHelperUser;
